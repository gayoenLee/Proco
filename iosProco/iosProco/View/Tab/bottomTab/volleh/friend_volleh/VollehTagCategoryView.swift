...
struct VollehTagCategoryView: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            .background(category_model.category_name == "사교/인맥" ? Color.proco_yellow : category_model.category_name == "게임/오락" ? .proco_pink : category_model.category_name == "문화/공연/축제" ? .proco_olive : category_model.category_name == "운동/스포츠" ? .proco_green : category_model.category_name == "취미/여가" ? .proco_mint : category_model.category_name == "스터디" ? .proco_blue : .proco_red )
            .cornerRadius(27.0)
            .onTapGesture {
                print("태그 카테고리 선택")
                ...
                if tag_num_over_three{
                 ...
                 print("태그 카테고리 이미 선택했음")
                    ...
                    //검색창에 추가됨
                    viewmodel.user_selected_tag_set.insert(category_model.category_name!)
                    ...
                    print("태그 카테고리 뷰모델에 넣어졌는지 확인 : \(self.viewmodel.user_selected_tag_list)")
                }
            }
    }
//        VStack{
