...
struct TagCategoryView: View {
    ...
    var body: some View {
        ...
        VStack{
            ...
            .background(tag_struct.category_name == "사교/인맥" ? Color.proco_yellow : tag_struct.category_name == "게임/오락" ? .proco_pink : tag_struct.category_name == "문화/공연/축제" ? .proco_olive : tag_struct.category_name == "운동/스포츠" ? .proco_green : tag_struct.category_name == "취미/여가" ? .proco_mint : tag_struct.category_name == "스터디" ? .proco_blue : .proco_red )
            .cornerRadius(27.0)
            .onTapGesture {
