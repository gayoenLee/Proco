        ...
        HStack{
            ...
            VStack{
                HStack{
                    ...
                    if apply_card.card_photo_path != nil || apply_card.card_photo_path != "" {
                        card_img
                    }
                   category_and_title
                    Spacer()
...
extension ApplyMeetingCard{
    ...
    var lock : some View{
        HStack{
            Image(self.apply_card.lock_state == 0 ? "lock_public" : "lock_private")
                .resizable()
    ...
    var like_icon_num : some View{
        HStack{
            ...
            Text(apply_card.like_count > 0 ? "좋아요\(apply_card.like_count)개" : "")
