            ...
            ForEach(report_menus, id: \.self){reason in
                ...
                Button(action: {
                    ...
                    HStack{
                        ...
                        ZStack{
                            Circle().fill(Color.yellow.opacity(0.5)).frame(width: UIScreen.main.bounds.width/20, height: UIScreen.main.bounds.width/20)
                            if self.selected == reason{
                                Circle().stroke(Color.yellow, lineWidth: 4).frame(width: UIScreen.main.bounds.width/30, height: UIScreen.main.bounds.width/30)
                            }
                        }
                    }
