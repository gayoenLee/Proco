                ...
                LazyVStack{
                    ForEach(0..<self.main_vm.noti_list_model.count, id: \.self){index in
                        ...
                        if index == self.main_vm.noti_list_model.count-1{
                            ...
                            NotiRow(noti: self.main_vm.noti_list_model[index], main_vm: self.main_vm, go_friend_manage: self.$go_friend_manage, go_friend_card_detail: self.$go_friend_card_detail, go_group_card_detail: self.$go_group_card_detail, go_feed: self.$go_feed, friend_card_vm: self.friend_card_vm, group_card_vm: self.group_card_vm, is_last: true)
                                .padding([.leading, .trailing, .bottom])
                            
                        }else{
                            
                            NotiRow(noti: self.main_vm.noti_list_model[index], main_vm: self.main_vm, go_friend_manage: self.$go_friend_manage, go_friend_card_detail: self.$go_friend_card_detail, go_group_card_detail: self.$go_group_card_detail, go_feed: self.$go_feed, friend_card_vm: self.friend_card_vm, group_card_vm: self.group_card_vm, is_last: false)
                                .padding([.leading, .trailing, .bottom])
                        }
                    }
                }
...
struct NotiRow: View{
    ...
    var body: some View{
        ...
        .onTapGesture {
            print("노티 한 개 클릭: 종류 - \(noti.kinds!), unique_idx:\(noti.unique_idx)")
