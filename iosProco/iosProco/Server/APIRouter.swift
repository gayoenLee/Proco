...
enum APIRouter: URLRequestConvertible {
    ...
    //설정 - 피드 알림 설정
    case edit_card_alarm_setting(card_notify_state: Int)
    //신고하기
    ...
    private var path: String{
        ...
        case .edit_chat_alarm_setting(_):
            return "/users/settings"
        //설정 - 피드알림
        case .edit_card_alarm_setting(_):
            return "/users/settings"
        //신고하기
    ...
    private var parameters: Parameters? {
        ...
        //설정 - 피드알림
        case .edit_card_alarm_setting(let card_notify_state):
            return [Keys.EditCardAlarmSetting.card_notify_state: card_notify_state]
        //신고하기
